...
async function deployERC20() {
  ...
  var name = "Dark Token";
  var symbol = "DarkTkn";
  var myTokenProxyContract = await deploySC("DarkToken", [name, symbol]);

  //Implementation Contract
  var darkTokenImplementationContract = await printAddress("DarkToken", myTokenProxyContract.address); 
...
async function deployERC721() {
  ...
  var nftContract = await deploySC("NftTicket", [name, symbol]);
